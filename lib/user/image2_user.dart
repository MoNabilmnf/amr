...
import 'package:amr/user/image1_user.dart';
...
class NextPage2_user extends StatefulWidget {

  @override
  NextPage2_userState createState() => NextPage2_userState();
}

class NextPage2_userState extends State<NextPage2_user> {
              ...
              child: RaisedButton(
                ...
                onPressed: (){
                  Navigator.pushReplacement(
                      context,
                      MaterialPageRoute(
                        builder: (context) => NextPage1_user(),
                      ));
                },
