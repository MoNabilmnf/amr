...
class discover_userRealySearch extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return discover_userRealySearchState();
  }
}

class discover_userRealySearchState extends State<discover_userRealySearch> {
                  ...
                  children: [
                    ...
                    (more == null)?Center(
                        ...
                        child: Column(children: [
                          Row(
                            children: [
                              Text("${more[index]['price'].toString()}",
                                  style: TextStyle(
                                      color: Colors.green,
                                      fontFamily: 'Jana',
