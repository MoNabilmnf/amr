...
class ForgotPass_user extends StatefulWidget {

  @override
  ForgotPass_userState createState() => ForgotPass_userState();
}

class ForgotPass_userState extends State<ForgotPass_user> {
