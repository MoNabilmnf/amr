...
class discover_userState extends State<discover_user>{
  ...
  List Cars = ['https://mostaql.hsoubcdn.com/uploads/563692-uwdvc-1563922230-5d378f36cc4e7.jpg','https://www.definicionabc.com/wp-content/uploads/tecnologia/App-Store.jpg','https://mostaql.hsoubcdn.com/uploads/376214-F9cqf-1521055150-Untitled-1.png'];
  ...
  List Cars2 = ["https://dubarter.s3-eu-west-1.amazonaws.com/2018/06/large-2565629033866609074.jpg","https://dubarter.s3-eu-west-1.amazonaws.com/2018/06/large-1993033583095106736.jpg","https://dubarter.s3-eu-west-1.amazonaws.com/2018/06/large-1577744743291838940.jpg"];
  int main = 2;
    ...
    body: Directionality(
     ...
     // Stack(children: [
        ...
        Container(child:SingleChildScrollView(scrollDirection: Axis.vertical,child:Container(child: Column(children: [
            ...
            Center(child: Container(margin: EdgeInsets.only(top: size.height*0.15,  bottom: 20),padding:EdgeInsets.all(10),
              ...
              child:  Row(children: [
                Expanded(flex: 6,child:  new GestureDetector(
                  ...
                  child: Container(padding: EdgeInsets.all(8),
                    ...
                    child: Row(children: [
                      ...
                      Text("    "),
                      Text("إبحث عن كل ما تريده",style: TextStyle(fontSize: 14,color: Colors.grey,fontFamily: 'Jana'),),
                ...
                Expanded(flex: 1,child: Container(
                  ...
                  child: IconButton(icon: Icon(Icons.tune,color: Colors.grey,),onPressed: (){
          ...
          Container(
            margin:EdgeInsets.only(left: 20,right: 20),child: Row(mainAxisAlignment:MainAxisAlignment.start,children: [
            Text("بائعين الاسبوع",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16,color: Colors.black,fontFamily: 'Jana'),),
            Spacer(),
            GestureDetector(onTap: (){
          ...
          Container(
            margin:EdgeInsets.only(left: 20,right: 20),child: Row(mainAxisAlignment:MainAxisAlignment.start,children: [
            Text("منتجات متميزه",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16,color: Colors.black,fontFamily: 'Jana'),),
            Spacer(),
                    ...
                    child: Column(
                      children: <Widget>[
                        Stack(alignment:Alignment.topLeft,children: [
                          ...
                          },child:Container(margin:EdgeInsets.all(5),child: (fa[index] == 1)?Icon(Icons.favorite,color: Colors.red,):Icon(Icons.favorite_border,color: Colors.grey,),)),),
          ...
          Container(
            margin:EdgeInsets.only(left: 20,right: 20),child: Row(mainAxisAlignment:MainAxisAlignment.start,children: [
            Text("سيارات",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16,color: Colors.black,fontFamily: 'Jana'),),
            Spacer(),
            Text("عرض الكل",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 12,color: Colors.grey,fontFamily: 'Jana'),),
            Text("  ",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 12,color: Colors.grey,fontFamily: 'Jana'),),
            Icon(Icons.arrow_back_ios_rounded,color: Colors.grey,size: 12,),
          ],),),
          Container(
                      ...
                      children: <Widget>[
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.all(Radius.circular(5.0)),
                            image: DecorationImage(
                              image: NetworkImage("${Cars2[index]}"),
                              fit: BoxFit.cover,
                            ),
                          ),
                        ),
...
//    Navigator.pushNamed(context, "Vendor");
  ...
  Widget buildSuggestions(BuildContext context) {
    final suggestionList = query.isEmpty?citic:citic.where((p)=> p.startsWith(query)).toList();
    return Directionality(
      textDirection: TextDirection.rtl,
      child:ListView.builder(itemBuilder: (context,index) => Container(padding: EdgeInsets.all(8),

      child: Directionality(
        textDirection: TextDirection.rtl,
        child:Column(mainAxisAlignment: MainAxisAlignment.start,children: [
          Row(children: [
            Text("${citics[index]}",style: TextStyle(color: Colors.green,fontFamily: 'Jana',fontWeight: FontWeight.bold,fontSize: 14)),
          ],),
        RichText(
          text:TextSpan(
              text: suggestionList[index].substring(0,query.length),
              style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontFamily: 'jana',
                fontSize: 16,),
              children: [
                TextSpan(
                    text: suggestionList[index].substring(query.length),
                    style: TextStyle(color: Colors.grey,fontFamily: 'jana',
                      fontSize: 16,)
                )
              ]
          ) ,
          ...
          Row(children: [
            Container(
              ...
              child: Row(mainAxisAlignment: MainAxisAlignment.center,
                children: <Widget>[
                  Text('${citics2[index]}', style: TextStyle(color: Colors.white,fontFamily: 'jana',
