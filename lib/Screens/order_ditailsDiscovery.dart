...
import 'package:amr/Screens/all_offersVendor.dart';
...
class order_ditailsDiscovery extends StatefulWidget{
  order_ditailsDiscovery({this.id});
  final int id;
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return order_ditailsDiscoveryState();
  }

}
class order_ditailsDiscoveryState extends State<order_ditailsDiscovery>{
                  ...
                  Row(mainAxisAlignment: MainAxisAlignment.center,children: [GestureDetector(
                    onTap: (){
                      ...
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => send_your_order(id:C['order']['id']),
                          ));
              ...
              child: Column(
                ...
                GestureDetector(onTap: (){
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => all_offersVendor(selectedID: C['order']['id'],),
                      ));
                },child:
  ...
  void getOrder() async {
   ...
   // String T = 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwczpcL1wvYW1lci5qaXQuc2FcL2FwaVwvdXNlclwvbG9naW4iLCJpYXQiOjE2MDkzMTcxNDQsImV4cCI6MTYwOTU3NjM0NCwibmJmIjoxNjA5MzE3MTQ0LCJqdGkiOiJ2anZuZThmZFpDTkRwTmZoIiwic3ViIjoxLCJwcnYiOiIyM2JkNWM4OTQ5ZjYwMGFkYjM5ZTcwMWM0MDA4NzJkYjdhNTk3NmY3In0.9n49oOiEnMVsebinIqqdtbj0hP70ziu1y9lE6C9SjY8';
    http.Response response = await http.get('https://amer.jit.sa/api/vendor/order/show/${widget.id}',headers: { HttpHeaders.authorizationHeader: T,"Accept":"application/json"},);
